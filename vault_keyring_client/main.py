...
@app.command()
def main(
    vault_id: str = typer.Option(None, '--vault-id', help="Name of the vault secret to get from keyring"),
    username: str = typer.Option(None, '--username', help="The username whose keyring is queried"),
    set_password: bool = typer.Option(False, '--set', help="Set the password instead of getting it")
):
